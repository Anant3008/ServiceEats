...
function CartContent() {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const defaultAddress =
        list.find((addr: Address) => addr.isDefault) || list[0] || null;
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setPaymentError(
        getErrorMessage(err, "Something went wrong processing payment"),
      );
      setProcessing(false);
    }
  };
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-900 leading-none uppercase tracking-wide">
                Checkout
              </h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-lg flex items-center gap-2">
                  <MapPin size={20} className="text-orange-600" /> Delivery to
                </h2>
                <button
              ...
              <div className="p-4 rounded-2xl border-2 border-orange-500 bg-orange-50/20 relative">
                <div className="absolute top-3 right-3 text-orange-600 bg-white rounded-full p-0.5">
                  <ShieldCheck
                    size={18}
                    fill="currentColor"
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-bold text-sm uppercase tracking-wide text-orange-700">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
              <h2 className="font-bold text-lg flex items-center gap-2 mb-6">
                <ShoppingBag size={20} className="text-orange-600" /> Your Items
              </h2>
                  ...
                  >
                    ...
                    <div className="h-9 bg-white border border-slate-200 rounded-lg flex items-center shadow-sm">
                      <button
                        ...
                        className="w-8 h-full flex items-center justify-center text-slate-400 hover:text-orange-600 hover:bg-orange-50 rounded-l-lg transition"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
              <div className="p-6 pb-4">
                <h2 className="font-bold text-slate-900 mb-6 flex items-center gap-2">
                  <Receipt size={20} className="text-orange-600" /> Bill Details
                </h2>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-orange-100 p-6 relative">
              ...
              <button
                ...
                disabled={
                  processing || !stripe || !elements || !selectedAddress
                }
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto space-y-3">
              {addresses.length === 0 ? (
                <div className="text-center py-8 text-slate-500">
                  ...
                  <Link
                    href="/profile"
                    className="text-orange-600 font-bold mt-2 inline-block"
                  >
                    Go to Profile
                  </Link>
                </div>
