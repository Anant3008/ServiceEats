                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm mb-1 line-clamp-1 ${notification.isRead ? "font-semibold text-slate-800" : "font-bold text-slate-900"}`}
                        >
                          {notification.title}
                        </p>
                        <p
                          className={`text-xs line-clamp-2 leading-relaxed ${notification.isRead ? "text-slate-500" : "text-slate-600 font-medium"}`}
                        >
